package org.apereo.cas.configuration.model.support.midpoint;
...
/**
 * This is {@link MidPointAuthenticationProperties}.
 *
 * @author Misagh Moayyed
 * @since 7.0.0
 */
@RequiresModule(name = "cas-server-support-midpoint")
@Getter
@Setter
@Accessors(chain = true)
@JsonFilter("MidPointAuthenticationProperties")
public class MidPointAuthenticationProperties implements CasFeatureModule, Serializable {
    @Serial
    private static final long serialVersionUID = -1236926316502297496L;

    @RequiredProperty
    private String url = "http://localhost:8080/midpoint/ws/rest";
     ...
     * of the collected attributes from midPoint. If an attribute is provided by midPoint,
     ...
     * midPoint attribute {@code lastLoginDate} and will internally rename that to {@code lastDate}.
     * If no mapping is specified, CAS defaults will be used instead.
     * In other words, this settings allows one to virtually rename and remap midPoint attributes
