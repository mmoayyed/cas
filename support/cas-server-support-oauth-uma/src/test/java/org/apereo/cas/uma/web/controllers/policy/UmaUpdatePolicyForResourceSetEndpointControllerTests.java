...
class UmaUpdatePolicyForResourceSetEndpointControllerTests extends BaseUmaEndpointControllerTests {
    ...
    void verifyNoAuth() throws Throwable {
        ...
        val result = performUmaRequest(HttpMethod.PUT, "1/" + OAuth20Constants.UMA_POLICY_URL + "/2", body);
    ...
    void verifyMissingResource() throws Throwable {
        ...
        val result = performUmaRequest(HttpMethod.PUT, "123/" + OAuth20Constants.UMA_POLICY_URL + "/2",
            body, results.getLeft(), results.getMiddle());
